...
#' package, based on the deep learning framework 'torch'. The \pkg{torch}
...
#' \item “Yhat”, a matrix of prediction values of sink and mediator graph nodes. 
...
#' @importFrom torch install_torch cuda_is_available       
#'
...
#' #In Windows, if C Visul Studio in not installed:
#' #download and install VC_redist.x64.exe file 
#'
#' \donttest{
#' # load ALS data
#' ig<- alsData$graph
